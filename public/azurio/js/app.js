...
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", mxdInit, { once: true });
} else {
  mxdInit();
}
// --------------------------------------------- //
...
function mxdLoader() {
  ...
  const imgLoad = typeof imagesLoaded === "function" ? imagesLoaded(content) : null;
  ...
  setTimeout(finishLoader, maxLoaderTime);
...
function startLoader() {
  ...
  if (!imgContainer || !counterElement) {
    return tl;
  }
...
function pageAppearance() {
  document.documentElement.classList.add("mxd-loader-complete");
  document.documentElement.classList.remove("mxd-fallback-visible");

  const loadingWrap = document.querySelector('.loading-wrap');
  const loadingItems = loadingWrap ? loadingWrap.querySelectorAll('.loading-item, .loading__item') : [];
  const loadingSplits = loadingWrap ? loadingWrap.querySelectorAll('.loading-split, .loading__split') : [];
  const loadingChars = loadingWrap ? loadingWrap.querySelectorAll('.loading-chars, .loading__chars') : [];

  const fadeInItems = document.querySelectorAll('.loading-fade, .loading__fade');
...
// --------------------------------------------- //
// Template Videos Autoplay Fallback Start
// --------------------------------------------- //
function mxdAutoplayTemplateVideos() {
...
// --------------------------------------------- //
// Template Videos Autoplay Fallback End
// --------------------------------------------- //

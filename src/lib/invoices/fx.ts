...
// Middle exchange rate for the RSD figure printed alongside a EUR total.
//
...
// own service is a SOAP endpoint behind registration). If the accountant wants
// the rate taken from the bank directly, this is the one function to swap.

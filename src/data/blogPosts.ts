...
const CORE_BLOG_POSTS: BlogPost[] = [
...

  {
    ...
    body: [
      ...
      { type: "p", text: "Rezultat: 0 termina dogovorenih na DM-ovima u prvom mesecu. Vlasnik štedi ~90 minuta dnevno. No-show stopa pala sa 18% na 4% zbog automatskih podsjetnika." },
...

  {
    ...
    body: [
      ...
      { type: "p", text: "Svaka odluka u arhitekturi utiče na SEO: struktura URL-ova, kako se renderuju podaci, da li stranice imaju statički HTML ili se generišu na klijentu, kako su slike optimizovane. Promijeniti te odluke posle lansiranja znači refaktoring koji košta 3-5x više od ispravnog rada od starta." },
...

  {
    ...
    body: [
      ...
      { type: "p", text: "Custom kod dolazi kada trebaš integracije sa legacy sistemima, specifičnu biznis logiku ili performanse koje n8n ne može da pruži. U 80% slučajeva, n8n je dovoljan." },
...

  {
    ...
    body: [
      ...
      { type: "p", text: "Svaki dodatni korak u checkout toku smanjuje konverziju za 10-20%. Guest checkout mora biti podrazumijevano — ne primoravaj korisnika da pravi nalog da bi platio. Nalog mogu napraviti posle, kada su već kupili i imaju razlog da se vrate." },
      ...
      { type: "p", text: "Više od 60% saobraćaja dolazi sa mobilnih uređaja, a konverzija na mobilnom je tipično 2-3x niža nego na desktopu. Razlog: forme sa sitnim fieldovima, dugmad koja su premala za prst, Apple/Google Pay nisu integrisani. Fix: native browser autofill, large touch targets, i payment sheet integracija." },
      { type: "callout", text: "Santos & Santorini je povećao mobilnu konverziju za 40% nakon što smo prešli na single-page checkout sa Apple Pay integracijom." },
      ...
      { type: "p", text: "Za Santos & Santorini, sagradili smo lager sistem koji prati svaki SKU u realnom vremenu, automatski skriva out-of-stock proizvode, i šalje notifikaciju administratoru kad zaliha padne ispod praga. Narudžbine koje nije moguće ispuniti: nula." },

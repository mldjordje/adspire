...
const sr: ContactCopy = {
  ...
  budgets: ["Još ne znam", "do 1.000 €", "1.000 – 2.800 €", "2.800 – 7.000 €", "preko 7.000 €"],
  timelines: ["Što pre", "1–3 meseca", "3–6 meseci", "Samo istražujem"],
  consent:
    "Saglasan sam da Adspire čuva ove podatke radi odgovora na moj upit. Ne šaljemo newsletter i ne prosleđujemo podatke trećim licima.",
  submit: "Pošalji upit →",
  sending: "Šaljem…",
...
const en: ContactCopy = {
  ...
  consent:
    "I agree that Adspire may store this data in order to answer my enquiry. We send no newsletter and share no data with third parties.",
  submit: "Send enquiry →",
  sending: "Sending…",
...
const de: ContactCopy = {
  ...
  consent:
    "Ich bin damit einverstanden, dass Adspire diese Daten zur Beantwortung meiner Anfrage speichert. Wir versenden keinen Newsletter und geben keine Daten an Dritte weiter.",

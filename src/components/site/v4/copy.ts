...
const sr: V4Copy = {
  ...
  hero: {
    ...
    trust: ["5+ sajtova i aplikacija uživo", "Google brzina 100/100", "Prototip za 48h"],
    scroll: "skroluj",
  },
  ...
  metrics: [
    "Google ocena brzine — maksimalnih 100",
...
const en: V4Copy = {
  ...
  hero: {
    ...
    trust: ["5+ sites & apps live", "Google speed 100/100", "Prototype in 48h"],
    scroll: "scroll",
  },
...
const de: V4Copy = {
  ...
  hero: {
    ...
    trust: ["5+ Websites & Apps live", "Google-Speed 100/100", "Prototyp in 48 h"],
    scroll: "scrollen",
  },

            ...
            <div className="col-12 col-lg-7 col-xl-5">
              <div className="text-center text-lg-start">
                <p className="primary-text">
                  Adspire je digitalna agencija iz Niša specijalizovana za
                  izradu web sajtova, web aplikacija i vođenje društvenih mreža.
                  Naš tim kombinuje kreativnost i tehnologiju kako bismo pomogli
                  brendovima da se istaknu online.
                </p>
              </div>
            </div>
          </div>

          ...
          <div className="col-12 col-lg-6">
            <div className="agency__content section__content">
              ...
              <h2 className="title title-anim">
                Mi smo kreativna digitalna agencija iz Srbije
              </h2>
              <div className="paragraph">
                <p>
                  Pomažemo brendovima da se istaknu na internetu kroz izradu
                  modernih web sajtova, funkcionalnih web aplikacija i efektan
                  digitalni marketing. Naš tim kombinuje dizajn, strategiju i
                  tehnologiju kako bi tvoje online prisustvo bilo profesionalno
                  i uvek korak ispred konkurencije.
                </p>
              </div>
              <div className="skill-wrap">
                <div className="skill-bar-single">
                  <div className="skill-bar-title">
                    <p className="primary-text">Izrada sajtova</p>
                  </div>
                ...
                <div className="skill-bar-single">
                  <div className="skill-bar-title">
                    <p className="primary-text">Web aplikacije</p>
                  </div>
                ...
                <div className="skill-bar-single">
                  <div className="skill-bar-title">
                    <p className="primary-text">Digitalni marketing</p>
                  </div>
